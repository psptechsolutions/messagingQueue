...
public class MessageSender {
	...
	public static void main(String[] args) throws JMSException {
		 ...
		 * AUTO_ACKNOWLEDGE. Specifies that the session is to automatically acknowledge consumer receipt of messages when message processing is complete.
		 */
		...
		TextMessage message = session.createTextMessage("Hi Panner, How are you?");
